...
customLabelArray: [2]
---
# <Label :level='2' href='https://github.com/flyhigher139/Git-Cheat-Sheet'/>Git 备忘清单
...
<ImgPreview filePath='/git/git-flow-commands.png'/>

### Git flow schema

<ImgPreview filePath='/git/git-flow-commands-without-flow.png'/>
